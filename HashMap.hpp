...
private:
    ...
    void create_bucket(Node** &b_array, const unsigned int& max_b_size);
    void copy_bucket(Node** target, Node** const &source, const unsigned int& a_size);
    void add_to_bucket(const std::string& key, const std::string& value, Node* &tail_pointer);
